...
const redirect_uri = "http://3.34.186.219:4000/redirect";
...
let corsOptions = {
  origin: ["http://kimcookieya.shop", "http://3.34.186.219:4000/"], // 클라이언트의 도메인
  credentials: true,
};
...
// 서버 - 포트 연결
app.listen(port, () => {
    console.log(`Listening on port: http://3.34.186.219:${port}`);
});
